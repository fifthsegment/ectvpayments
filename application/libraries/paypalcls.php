...
class paypalcls {
   ...
   var $acknowledgement_url;
   var $return_url;
   var $notify_url;
   var $achknowledgement_host;
   ...
   public function __construct() {
      ...
      $this->acknowledgement_url = 'ssl://www.sandbox.paypal.com';
      $this->achknowledgement_host = 'www.sandbox.paypal.com';
      $this->last_error = '';
      $this->business = '';
      $this->ipn_log_file = 'paymentsystem/.ipn_results.log';
      $this->ipn_log = true; 
      $this->ipn_response = '';
   ...
   public function sandbox ($status){
      if (!$status){
        $this->paypal_url = 'https://www.sandbox.paypal.com/cgi-bin/webscr';
        $this->acknowledgement_url = 'ssl://www.paypal.com';
        $this->acknowledgement_host = 'www.paypal.com';
      }
   }
   ...
   function validate_ipn(){
       //Set up the acknowledgement request headers
        ...
        $header .= "Host: $this->achknowledgement_host\r\n";
        $header .= "Content-Type: application/x-www-form-urlencoded\r\n";
        $header .= "Content-Length: " . strlen($req) . "\r\n\r\n";

        //Open a socket for the acknowledgement request
        $fp = fsockopen ($this->acknowledgement_url, 443, $errno, $errstr, 30);
